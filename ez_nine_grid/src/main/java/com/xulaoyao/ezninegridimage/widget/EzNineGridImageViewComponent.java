package com.xulaoyao.ezninegridimage.widget;
...
public class EzNineGridImageViewComponent extends AppCompatImageView {
    ...
    public EzNineGridImageViewComponent(Context context) {
        this(context, null);
    }

    public EzNineGridImageViewComponent(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EzNineGridImageViewComponent(Context context, AttributeSet attrs, int defStyleAttr) {
